...
def binance_transactions():
    ...
    txs = {}
    assets = set()
    apiclient = binance.client.Client(apikeys.binance['apiKey'], apikeys.binance['secret'])
...
def gdax_transactions():
    transactions = []
    apiclient = gdax.AuthenticatedClient(apikeys.gdax['apiKey'], apikeys.gdax['secret'], apikeys.gdax['password'])
...
def coinbase_transactions():
    transactions = []
    apiclient = coinbase_client.Client(apikeys.coinbase['apiKey'], apikeys.coinbase['secret'])
    c = apiclient
